...
class BilingualDataset(Dataset):
    ...
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, sequence_len):
        super().__init__()
    ...
    def __getitem__(self, idx):
        ...
        dec_num_padding_tokens = self.sequence_len - len(dec_input_tokens) - 1
        ...
        # Double check the size of the tensors to make sure they are all sequence_len long
        ...
        return {
            ...
            "decoder_mask": (decoder_input != self.pad_token).unsqueeze(0).int() & causal_mask(decoder_input.size(0)), # (1, sequence_len) & (1, sequence_len, sequence_len),
